Pod::Spec.new do |s|
  ...
  s.author       = "Idemia"
  s.platform     = :ios, "11.0"
  s.source       = { :git => "https://github.com/ZYTRUST/BiometricSDKAlgorithmPlugin_F6_0_IDD80.git", :tag => "4.33.0" }
  s.requires_arc = true
  s.vendored_frameworks = "BiometricSDKAlgorithmPlugin_F6_0_IDD80.framework"
end
